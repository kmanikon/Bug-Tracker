...
/*
    ...
    project select for user profile
...
const UserProfileCard = ({projects, actions, changeCount }) => {
                ...
                {rows.map(row => {
                    ...
                    return (
                        <>
                            ...
                            <Link to="/profileHistory" state={{ project: data[row.id], history: actions, changeCount: changeCount }}>
